...
public class MyReceiver3 extends BroadcastReceiver {
    public static final String MY_ACTION3 = "com.example.busreceiver.action.ACTION_MY_BROADCAST";
    @Override
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (MY_ACTION3.equals(intent.getAction())) {
                ...
                List<BusTime> busTimes = db.busTimeDao().getAll("대림대→안양역");
